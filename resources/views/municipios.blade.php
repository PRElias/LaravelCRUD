...
<html lang="{{ app()->getLocale() }}">
  ...
  <table class="table">
    ...
    <tr>
        ...
        <th scope="col"><a href="/municipios/novo">Novo</a></th>
      </tr>
    </thead>
    <tbody>
        ...
        <td><a href="/municipios/editar/{{ $municipio->COD_MUNICIPIO }}">Editar</a> / <a class="b_del" href="#" onclick="deleteConfirm('{{ $municipio->COD_MUNICIPIO }}')" >Excluir</a></td>
        </tr>
        @endforeach
    </tbody>
  </table>
...
<div id="dialog" title="Confirmar exclusão" style="display: none">
    Tem certeza que deseja excluir? Esta ação não pode ser desfeita.
        ...
        <script src="{{ asset('js/javascript-mun.js') }}"></script>
    </body>
</html>
