...
{{ Form::model($uf, array('route' => array('uf-salvar', $uf->SGL_UNIDADE_FEDERATIVA), 'method' => 'GET')) }}
{{ Form::hidden('inputSigla', $uf->SGL_UNIDADE_FEDERATIVA, array('class' => 'form-control')) }}
    <div class="form-group">
      <label for="inputNome">Nome</label>
      {{ Form::text('inputNome', $uf->NOM_UNIDADE_FEDERATIVA, array('class' => 'form-control', 'required' => 'required')) }}
    </div>
